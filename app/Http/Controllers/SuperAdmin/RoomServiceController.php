...
{
    /**
     * GET /super-admin/room-service/requests
     * Show all room service requests with pagination.
     */
    public function index(Request $request)
    {
        ...
        return view('content.super-admin.room-service.orders', compact('requests', 'stats'));
    }

    /**
     * PATCH /super-admin/room-service/requests/{id}/status
    ...
    public function updateStatus(Request $request, int $id)
    {
        ...
        // Guard: don't move backwards or re-cancel
        ...
        Log::info("Room service request #{$id} status changed from {$oldStatus} to {$newStatus}.");
