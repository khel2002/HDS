...
// Initialize Bootstrap dropdowns with better positioning
function initializeDropdowns() {
    // Get all dropdown toggles in the table
    const dropdownToggles = document.querySelectorAll('.table .dropdown-toggle, .table [data-bs-toggle="dropdown"]');
    ...
    dropdownToggles.forEach(toggle => {
        toggle.addEventListener('show.bs.dropdown', function(e) {
            ...
            if (dropdown && dropdown.classList.contains('dropdown-menu')) {
                ...
                const tableRect = this.closest('.table-responsive').getBoundingClientRect();
