...
@section('content')
        ...
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              ...
              <p class="mb-0 text-body-secondary">Review and manage all breakfast service requests from guests</p>
            </div>
              ...
              <tbody id="ordersTableBody">
                @forelse($orders as $order)
                  ...
                  <tr class="order-row"
                      ...
                      data-status-url="{{ route('super_admin.breakfast.orders.status', $order->service_request_id) }}"
                      ...
                      <div class="d-flex align-items-center justify-content-center gap-1">
                        ...
                        @if($order->request_status === 'pending')
                          <button type="button"
                                  ...
                                  data-url="{{ route('super_admin.breakfast.orders.status', $order->service_request_id) }}"
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row g-4">
                ...
                <div class="card border h-100 mb-0">
                  <div class="card-body">
                    ...
                    @if($guest)
                      ...
                      @if($guest->contact_number)
                        <p class="mb-1 small text-body-secondary"><i class="ri ri-phone-line me-1"></i>{{ $guest->contact_number }}</p>
                      @endif
                      @if($guest->dob)
                        <p class="mb-0 small text-body-secondary"><i class="ri ri-cake-line me-1"></i>{{ \Carbon\Carbon::parse($guest->dob)->format('M d, Y') }}</p>
                      @endif
                    @else
              ...
              {{-- Status Timeline + Request Info --}}
              <div class="col-12">

                {{-- ▼▼▼ THE FIX: .modal-timeline wrapper so JS can find & replace it ▼▼▼ --}}
          ...
          <div class="modal-footer justify-content-between">
            ...
            <div class="d-flex gap-2 modal-footer-actions">
              {{-- Filled by orders_script.js on show.bs.modal --}}
            </div>
          </div>
  ...
  <script src="{{ asset('js/breakfastjs/orders_script.js') }}"></script>
@endsection