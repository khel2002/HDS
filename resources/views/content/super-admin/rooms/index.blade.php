            ...
            <tbody>
              @foreach ($rooms as $room)
                <tr>
                  ...
                  <td>
                    @if ($room->image_path)
                      <img src="{{ asset('storage/' . $room->image_path) }}" alt="{{ $room->room_type_name }}"
                  ...
                  <td>
                    <span class="badge bg-label-info rounded-pill">{{ $room->max_pax }}
                      {{ $room->max_pax > 1 ? 'Guests' : 'Guest' }}</span>
                  </td>
                  <td>
                      ...
                      <div class="d-flex flex-wrap gap-1">
                        ...
                        @if (count($room->amenities) > 2)
                          <span class="badge bg-label-secondary cursor-pointer" style="font-size: 0.75rem;"
                            data-bs-toggle="modal" data-bs-target="#amenitiesModal{{ $room->room_id }}" role="button">
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      <button class="btn btn-sm btn-icon btn-text-secondary rounded-pill" type="button"
                        ...
                        data-bs-target="#viewDetailsModal{{ $room->room_id }}">
            ...
            <div class="modal-body">
              <div class="row">
                ...
                <div class="col-lg-5 mb-4 mb-lg-0">
                  @if ($room->image_path)
                    <img src="{{ asset('storage/' . $room->image_path) }}" class="img-fluid rounded"
                      alt="{{ $room->room_type_name }}" style="width: 100%; height: 400px; object-fit: cover;">
                  @else
                    <div class="bg-label-secondary rounded d-flex align-items-center justify-content-center"
                ...
                @foreach ($roomTypes as $type)
                  ...
                  <tr>
                    ...
                    <td class="text-truncate" style="max-width: 250px;" data-bs-toggle="tooltip"
                      data-bs-placement="top" title="{{ $type->description ?? 'N/A' }}">
                      {{ $type->description ?? 'N/A' }}</td>
