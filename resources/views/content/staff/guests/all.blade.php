...
<script>
  const ROUTES = {
    show:         '{{ route('staff.guests.show', ':id') }}',
    updateStatus: '{{ route('staff.guests.update-status', ':id') }}',
    all:          '{{ route('staff.guests.all') }}',
    csrfToken:    '{{ csrf_token() }}',
  };
</script>
<script src="{{ asset('js/guestjs/staff_guest_script.js') }}"></script>
@endsection