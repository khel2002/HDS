...
<div class="row gy-6">
      ...
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
          ...
          <div class="d-flex gap-2">
            <a href="{{ route('staff.registration.check-in') }}" class="btn btn-primary btn-sm">
              <i class="icon-base ri ri-login-box-line me-1"></i> Check-in
            </a>
            <a href="{{ route('staff.registration.check-out') }}" class="btn btn-warning btn-sm">
  ...
  <div class="col-12">
    <div class="card">
      <div class="card-body">
        <form method="GET" action="{{ route('staff.registration.all') }}" class="row g-3">
          <div class="col-md-3">
          ...
          <div class="col-md-3 d-flex align-items-end gap-2">
            ...
            <a href="{{ route('staff.registration.all') }}" class="btn btn-outline-secondary flex-fill">
                ...
                <tr>
                  ...
                  <td>
                    <div class="d-flex gap-1">
                      <a href="{{ route('staff.registration.show', $reg->registration_id) }}"
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        ...
                        <form action="{{ route('staff.registration.process-check-out', $reg->registration_id) }}" method="POST">
                          @csrf
